...
<h1><a class="back-button" href="main.php">Back</a>Bill Records For Suppliers</h1>
...
<table>
    ...
    $query = "SELECT bill_id, bill_amt, emp_id, sup_id, branch_id, bill_time, bill_date FROM bill WHERE cus_id IS NULL";
