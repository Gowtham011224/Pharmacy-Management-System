...
<h1><a class="back-button" href="main.php">Back</a>Transaction Records For Suppliers</h1>
...
<table>
    ...
    $query = "SELECT tran_id, tran_amt, emp_id, sup_id, bill_id, tran_type, tran_date, tran_time, branch_id FROM transaction WHERE cus_id IS NULL";
